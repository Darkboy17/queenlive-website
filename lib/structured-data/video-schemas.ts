...
export const videoSchemas = [
  {
    ...
    description:
        "지난 7월 9일 롯데월드타워에서 성황리에 개최된 제2회 'Growth with Clickmate",
  ...
  },
  {
    ...
    description:
      "클릭메이트 플랫폼의 주요 기능과 특징을 소개하는 영상입니다. 라이브커머스의 모든 기능을 한눈에 확인할 수 있습니다.",
  ...
  },
  {
    ...
    name: "클릭메이트 셀러 성공 사례",
    description:
      "클릭메이트를 통해 성공한 셀러들의 이야기를 담은 영상입니다. 실제 매출 성과와 성공 비결을 공유합니다.",
